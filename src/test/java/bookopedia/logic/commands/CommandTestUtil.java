...
public class CommandTestUtil {
    ...
    public static final String DELIVERY_STATUS_OTW = " " + PREFIX_TAG + VALID_DELIVERY_STATUS;
    ...
    public static final String INVALID_DELIVERY_STATUS_DESC = " " + PREFIX_TAG + "complete"; // not a valid status
