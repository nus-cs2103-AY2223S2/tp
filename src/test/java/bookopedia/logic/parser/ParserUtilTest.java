...
import static bookopedia.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    public void parseTag_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseParcel(null));
    }

    @Test
    public void parseTag_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseParcel(INVALID_TAG));
    }

    @Test
    public void parseTag_validValueWithoutWhitespace_returnsTag() throws Exception {
        Parcel expectedParcel = new Parcel(VALID_TAG_1);
        assertEquals(expectedParcel, ParserUtil.parseParcel(VALID_TAG_1));
    }
    ...
    public void parseTag_validValueWithWhitespace_returnsTrimmedTag() throws Exception {
        ...
        Parcel expectedParcel = new Parcel(VALID_TAG_1);
        assertEquals(expectedParcel, ParserUtil.parseParcel(tagWithWhitespace));
    }

    @Test
    public void parseTags_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseParcels(null));
    }

    @Test
    public void parseTags_collectionWithInvalidTags_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseParcels(Arrays.asList(VALID_TAG_1, INVALID_TAG)));
    }

    @Test
    public void parseTags_emptyCollection_returnsEmptySet() throws Exception {
        assertTrue(ParserUtil.parseParcels(Collections.emptyList()).isEmpty());
    }
