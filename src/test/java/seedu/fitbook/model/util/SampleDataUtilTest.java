...
import static seedu.fitbook.model.util.SampleDataUtil.getRoutineSet;
    ...
    public void getSampleClients() {
        Client[] testClient = new Client[] {
            ...
            new Client(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                ...
                getAppointmentSet("12-06-2023 18:30"), new Weight("40"), new Gender("M"),
                new Calorie("1200"), new Goal("lose weight"), getTagSet("family"), getRoutineSet()),
