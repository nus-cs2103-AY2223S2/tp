...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + VALID_CCA_NES + VALID_CCA_POSITION_DIRECTOR, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                ...
                + VALID_CCA_NES + VALID_CCA_POSITION_DIRECTOR, new AddCommand(expectedPersonMultipleTags));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                ...
                + VALID_CCA_NES + VALID_CCA_POSITION_DIRECTOR,
        ...
        Person expectedPersonMultipleCcas = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND)
                .withModules(VALID_MODULE_CS2103T).withCcas(VALID_CCA_NES, VALID_CCA_ICS).build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + TAG_DESC_FRIEND + MODULE_DESC_CS2103T + MODULE_DESC_CS2101
                        + CCA_DESC_NES + CCA_DESC_ICS,
