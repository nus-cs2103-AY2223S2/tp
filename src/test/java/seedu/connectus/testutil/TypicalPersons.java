...
public class TypicalPersons {
    ...
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withPhone("98765432")
            .withRemarks("owesMoney", "friends")
            .withBirthday("30/04/2004")
            .withModules("CS2103T")
            .withCcas("ICS")
            .withMajors("Computer Science")
            .build();
    ...
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").
            ...
            .withCcas("ICS")
            .build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meier")
            .withPhone("9482224")
            .withEmail("werner@example.com")
            .withAddress("michegan ave")
            .withMajors("CE")
            .withModules("CS2101", "CS2103T")
            .build();
