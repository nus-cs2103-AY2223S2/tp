...
public class CsvSerializableDengueHotspotTrackerTest {

    private static final Path TEST_DATA_FOLDER = Paths.get("src",
            "test", "data", "CsvSerializableDengueHotspotTrackerTest");
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        CsvSerializableDengueHotspotTracker dataFromFile = JsonUtil.readJsonFile(TYPICAL_PERSONS_FILE,
                CsvSerializableDengueHotspotTracker.class).get();
    ...
    public void toModelType_invalidPersonFile_throwsIllegalValueException() throws Exception {
        CsvSerializableDengueHotspotTracker dataFromFile = JsonUtil.readJsonFile(INVALID_PERSON_FILE,
                CsvSerializableDengueHotspotTracker.class).get();
    ...
    public void toModelType_duplicatePersons_throwsIllegalValueException() throws Exception {
        CsvSerializableDengueHotspotTracker dataFromFile = JsonUtil.readJsonFile(DUPLICATE_PERSON_FILE,
                CsvSerializableDengueHotspotTracker.class).get();
        assertThrows(IllegalValueException.class, CsvSerializableDengueHotspotTracker.MESSAGE_DUPLICATE_PERSON,
