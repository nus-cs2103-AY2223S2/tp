...
import static seedu.quickcontacts.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonQuickBookStorage quickBookStorage =
                new JsonQuickBookStorage(temporaryFolder.resolve("quickcontacts.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(quickBookStorage, userPrefsStorage);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonQuickBookIoExceptionThrowingStub
        JsonQuickBookStorage quickBookStorage =
                new JsonQuickBookIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionQuickBook.json"));
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        Model expectedModel = new ModelManager(model.getQuickBook(), new UserPrefs());
     ...
     */
    private static class JsonQuickBookIoExceptionThrowingStub extends JsonQuickBookStorage {
        private JsonQuickBookIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
