...
//import seedu.medinfo.testutil.EditPersonDescriptorBuilder;
...
public class EditCommandParserTest {
    ...
    //
    //        EditPatientDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).build();
    ...
    //        String userInput = targetIndex.getOneBased() + "Some valid fields: EditCommandParserTest";
    //
    //        EditCommand.EditPatientDescriptor descriptor = new EditPersonDescriptorBuilder().build();
    //        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    //
    //        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    //
    //        // nric
    //        userInput = targetIndex.getOneBased() + VALID_NRIC_AMY;
    ...
    //        Index targetIndex = INDEX_FIRST_PERSON;
    //        String userInput = targetIndex.getOneBased() + "Multiple repeated fields";
    //
    //        EditPatientDescriptor descriptor = new EditPersonDescriptorBuilder().build();
    //        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    //
    //        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    //        Index targetIndex = INDEX_FIRST_PERSON;
    //        String userInput = targetIndex.getOneBased() + "Invalid values only: EditCommandParserTest";
    //        EditCommand.EditPatientDescriptor descriptor = new EditPersonDescriptorBuilder().build();
    //        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    //        assertParseSuccess(parser, userInput, expectedCommand);
    //
    //        // other valid values specified
    //        userInput = targetIndex.getOneBased() + "Invalid value with some valid values: EditCommandParserTest";
    //        descriptor = new EditPersonDescriptorBuilder().build();
    //        expectedCommand = new EditCommand(targetIndex, descriptor);
    //        assertParseSuccess(parser, userInput, expectedCommand);
    }
