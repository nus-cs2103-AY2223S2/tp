    ...
    public static final Recipe MASALA_DOSA = new RecipeBuilder(
            ...
            List.of(
                    ...
                    new Step("Combine the two pastes in a medium mixing bowl. Whisk together, adding "
                                     ...
                                     + "away "
                                     + "or refrigerate for later use. (Batter will keep for up to a week, "
                                     + "refrigerated. "
                    ...
                    new Step("Make the potato filling: Put ghee in a wide skillet over medium heat. "
                                     ...
                                     + "have "
                                     + "softened, about 5 minutes. Season lightly with salt. Add turmeric, asafetida,"
                                     + " ginger, "
                                     + "curry leaves, garlic and green chile. Stir to coat and let sizzle for 1 "
                                     + "minute."),
                    ...
                    new Step("To make dosas, set a griddle or cast-iron skillet over medium heat. "
                                     ...
                                     + "circular motion "
                                     + "to a diameter of about 7 inches. Drizzle 0.5 teaspoon oil over the top. Leave"
                                     + " dosa batter"
                                     + " to brown "
                                     + "gradually until outer edges begin to look dry, about 2 minutes, cooking on "
                                     + "one side"
                                     + " only. With a spatula, carefully loosen dosa from griddle. Bottom should be "
                                     + "crisp and "
                                     + "beautifully browned. Spoon 0.5 cup potato filling onto top of dosa, centering"
                                     + " it as a"
                                     + " strip in the middle of the round dosa. Flatten the potato mixture slightly. "
                                     + "Using "
                                     + "the spatula, fold the sides of the dosa around the filling to make a "
                                     + "cylindrical shape."
    ...
    public static final Recipe GRILLED_CHEESE = new RecipeBuilder(
            ...
            List.of(
                    new Step("Butter the bread. Put a wedge of camembert or brie on the unbuttered side of one slice of"
                                     + " bread. Top with a spoonful of cranberry sauce. Drizzle with a few drops of "
                                     + "balsamic"
                                     + " vinegar, if you have some."),
                    new Step("Put the second slice of bread on top, buttered side out. Fry in a hot non-stick pan,"
                                     + " pressing down with a fish slice, for a minute or two on each side, until "
                                     + "golden brown"
    ...
    public static final Recipe FISH_AND_CHIPS = new RecipeBuilder(
            ...
            List.of(
                    ...
                    new Step("In a bowl whisk together flour, baking soda, curry powder and beer. Then whisk egg whites"
                                     + " till there are stiff peaks and fold into batter (if too heavy add some "
                                     + "water)"),
                    ...
                    new Step(
                            "Once fish is in, baste the fish with oil. Let first side cook until golden brown and flip."
                                    + " Basting fish with oil on other side. Take pan on and off oil so that the oil "
                                    + "does not get"
                                    + " too hot. Fish should be in oil 3-3.5 minutes. Once finished put on plate with"
                                    + " paper towel"
                                    + " and put in warm oven"),
                    new Step(
                            "Chop potato into square, then chop into tall skinny fries (the skinnier the fry the "
                                    + "quicker"
                                    + " they will cook). Then roll in paper towel to dry any excess moisture. Add new"
                                    + " oil to pain"
                                    + " then add potatoes to high heat. Once fries are browned, remove from oil on to"
                                    + " paper towel"
                                    + " and add salt."),
