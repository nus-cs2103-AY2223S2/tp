...
public class CommandTestUtil {
    ...
    public static final String INVALID_TITLE_DESC = " " + PREFIX_TITLE + "Sushi&";
    public static final String INVALID_DESC_DESC = " " + PREFIX_DESCRIPTION + "Hooray!";
    public static final String INVALID_STEP_DESC = " " + PREFIX_STEP + "boil water & flour";
    ...
    public static void showRecipeAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredRecipeList(new TitleContainsKeywordsPredicate(Arrays.asList(splitName[0])));
