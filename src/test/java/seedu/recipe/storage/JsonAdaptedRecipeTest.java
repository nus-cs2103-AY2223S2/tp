...
public class JsonAdaptedRecipeTest {
    ...
    public void toModelType_invalidTitle_throwsIllegalValueException() {
        JsonAdaptedRecipe recipe =
                new JsonAdaptedRecipe(INVALID_TITLE, VALID_DESC, VALID_INGREDIENTS, VALID_STEPS);
    ...
    public void toModelType_invalidDesc_throwsIllegalValueException() {
        JsonAdaptedRecipe recipe = new JsonAdaptedRecipe(VALID_TITLE, INVALID_DESC, VALID_INGREDIENTS, VALID_STEPS);
    ...
    public void toModelType_invalidIngredients_throwsIllegalValueException() {
        ...
        JsonAdaptedRecipe recipe = new JsonAdaptedRecipe(VALID_TITLE, VALID_DESC, invalidIngredients, VALID_STEPS);
    ...
    public void toModelType_invalidSteps_throwsIllegalValueException() {
        ...
        JsonAdaptedRecipe recipe = new JsonAdaptedRecipe(VALID_TITLE, VALID_DESC, VALID_INGREDIENTS, invalidSteps);
        assertThrows(IllegalValueException.class, recipe::toModelType);
    }
}
