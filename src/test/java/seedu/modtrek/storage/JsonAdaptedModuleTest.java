...
public class JsonAdaptedModuleTest {
    ...
    public void toModelType_invalidCode_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(INVALID_NAME, VALID_CREDIT, VALID_SEMYEAR, VALID_GRADE, VALID_TAGS);
    ...
    public void toModelType_nullCode_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(null, VALID_CREDIT, VALID_SEMYEAR, VALID_GRADE, VALID_TAGS);
    ...
    public void toModelType_invalidCredit_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(VALID_NAME, INVALID_CREDIT, VALID_SEMYEAR, VALID_GRADE, VALID_TAGS);
    ...
    public void toModelType_nullCredit_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(VALID_NAME, null, VALID_SEMYEAR, VALID_GRADE, VALID_TAGS);
    ...
    public void toModelType_invalidSemYear_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(VALID_NAME, VALID_CREDIT, INVALID_SEMYEAR, VALID_GRADE, VALID_TAGS);
    ...
    public void toModelType_nullSemYear_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(VALID_NAME, VALID_CREDIT, null, VALID_GRADE, VALID_TAGS);
    ...
    public void toModelType_nullGrade_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(VALID_NAME, VALID_CREDIT, VALID_SEMYEAR, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedModule module =
                new JsonAdaptedModule(VALID_NAME, VALID_CREDIT, VALID_SEMYEAR, VALID_GRADE, invalidTags);
