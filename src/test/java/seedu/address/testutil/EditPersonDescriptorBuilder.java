...
public class EditPersonDescriptorBuilder {
    ...
    public EditPersonDescriptorBuilder(Person person) {
        ...
        descriptor.setStation(person.getStation());
    ...
    /**
     * Sets the {@code Station} of the {@code EditPersonDescriptor} that we are building.
     */
    public EditPersonDescriptorBuilder withStation(String station) {
        descriptor.setStation(new Station(station));
        return this;
    }
