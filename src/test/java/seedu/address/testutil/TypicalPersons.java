...
import static seedu.address.logic.commands.CommandTestUtil.VALID_APPLICATIONDATE_AMY;
import static seedu.address.logic.commands.CommandTestUtil.VALID_APPLICATIONDATE_BOB;
...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withApplicationDateTime("02-02-2023 14:00")
            .withInterviewDateTime("")
            .withNotes("friends").build();
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            ...
            .withStatus("ACCEPTED")
            .withApplicationDateTime("02-02-2023 14:00")
            .withInterviewDateTime("04-03-2024 13:00").build();
    ...
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            ...
            .withStatus("SHORTLISTED")
            .withApplicationDateTime("02-02-2023 14:00")
            .withInterviewDateTime("05-07-2023 19:00").build();
     ...
     */
    public static HMHero getTypicalAddressBook() {
        HMHero ab = new HMHero();
