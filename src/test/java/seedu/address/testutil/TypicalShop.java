...
public class TypicalShop {
    ...
    public Appointment[] getSampleAppointments() {
        ...
        return new Appointment[] {
            new Appointment(idGenerator.generateAppointmentId(), 1,
                    LocalDateTime.parse("10/12/2022 02:00 PM", dtf), getIntegerSet(1)),
            new Appointment(idGenerator.generateAppointmentId(), 1,
                    LocalDateTime.parse("21/12/2022 02:30 PM", dtf), getIntegerSet(2)),
