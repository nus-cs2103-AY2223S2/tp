...
public class TypicalCards {
    ...
    public static final Card LOOP = new PersonBuilder().withName("What is a loop")
    ...
    public static final Card VARIABLE = new PersonBuilder().withName("What is a variable")
            .withAddress("A named memory location that stores a value")
            .withTags("Hard").withDeck("Programming Concepts").build();
    public static final Card ATOM = new PersonBuilder().withName("What is the structure of an atom")
    ...
    public static final Card LIFE = new PersonBuilder().withName("What is the basic unit of life")
            .withAddress("The cell is the basic unit of life").withTags("Medium")
            .withDeck("Science").build();
    public static final Card PRESIDENT = new PersonBuilder()
            .withName("Who was the first president of the United States")
            .withAddress("George Washington").withDeck("History").build();
    public static final Card INDEPENDENCE = new PersonBuilder().withName("When did Singapore gain independence")
            .withAddress("9 August 1965").withDeck("History").build();
    public static final Card EARTHQUAKE = new PersonBuilder().withName("What is an earthquake")
    ...
    // Manually added
    public static final Card SMOG = new PersonBuilder().withName("What is smog")
            .withAddress("A mixture of smoke and fog, caused by pollutants in the atmosphere")
            .withDeck("Geography").build();
    public static final Card FRACTION = new PersonBuilder().withName("What is a fraction")
    ...
    public static final Card GRAVITY = new PersonBuilder().withName(VALID_QUESTION_GRAVITY)
            .withAddress(VALID_ANSWER_GRAVITY).withTags(VALID_TAG_MEDIUM).withDeck(VALID_DECK_SCIENCE).build();
    public static final Card PHOTOSYNTHESIS = new PersonBuilder().withName(VALID_NAME_PHOTOSYNTHESIS)
