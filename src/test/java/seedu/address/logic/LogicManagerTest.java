...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        JsonDeliveryJobSystemStorage deliveryJobSystemStorage = new JsonDeliveryJobSystemStorage(
                temporaryFolder.resolve("deliveryJobSystem.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(addressBookStorage, deliveryJobSystemStorage, userPrefsStorage);
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        Model expectedModel = new ModelManager(model.getAddressBook(), model.getDeliveryJobSystem(), new UserPrefs());
