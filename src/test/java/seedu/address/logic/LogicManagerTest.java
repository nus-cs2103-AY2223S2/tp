...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonExecutiveProStorage addressBookStorage =
                new JsonExecutiveProStorage(temporaryFolder.resolve("addressBook.json"));
     ...
     */
    private static class JsonExecutiveProIoExceptionThrowingStub extends JsonExecutiveProStorage {
        private JsonExecutiveProIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
