...
import static seedu.address.logic.commands.CommandTestUtil.TAGS_DESC_AMY;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + TAGS_DESC_AMY + GENDER_DESC_AMY + MAJOR_DESC_AMY + RACE_DESC_AMY + COMMS_DESC_AMY + FACULTY_DESC_AMY;
        Person amy = AMY;
