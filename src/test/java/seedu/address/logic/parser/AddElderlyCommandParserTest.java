...
public class AddElderlyCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB + RISK_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_AMY + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB + RISK_DESC_BOB
                + TAG_DESC_STRONG + AVAILABLE_DATES_ONE, new AddElderlyCommand(expectedElderly));

        // multiple age - last age accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_AMY + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB + RISK_DESC_BOB
                + TAG_DESC_STRONG + AVAILABLE_DATES_ONE, new AddElderlyCommand(expectedElderly));

        // multiple region - last region accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + REGION_DESC_AMY + REGION_DESC_BOB + RISK_DESC_BOB
                + TAG_DESC_STRONG + AVAILABLE_DATES_ONE, new AddElderlyCommand(expectedElderly));

        // multiple risk levels - last risk level accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB + RISK_DESC_AMY + RISK_DESC_BOB
                + TAG_DESC_STRONG + AVAILABLE_DATES_ONE, new AddElderlyCommand(expectedElderly));
        ...
        Elderly expectedElderlyMultipleDates = new ElderlyBuilder(BOB).withTags(VALID_TAG_STRONG, VALID_TAG_SINGLE)
                ...
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB
        ...
        Elderly expectedElderlyMultipleTags = new ElderlyBuilder(BOB).withTags(VALID_TAG_STRONG, VALID_TAG_SINGLE)
                ...
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB + RISK_DESC_BOB + TAG_DESC_SINGLE
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + NRIC_ELDERLY_DESC_AMY + BIRTH_DATE_DESC_AMY + REGION_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + VALID_REGION_BOB + RISK_DESC_BOB, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid nric
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_ELDERLY_NRIC_DESC + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB + RISK_DESC_BOB
                + TAG_DESC_SINGLE + TAG_DESC_STRONG + AVAILABLE_DATES_ONE, Nric.MESSAGE_CONSTRAINTS);

        // invalid birth date
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_BOB + INVALID_BIRTH_DATE_DESC + REGION_DESC_BOB + RISK_DESC_BOB
        ...
        // invalid region
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + INVALID_REGION_DESC + RISK_DESC_BOB
                + TAG_DESC_SINGLE + TAG_DESC_STRONG, Region.MESSAGE_CONSTRAINTS);

        // invalid risk level
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB + INVALID_RISK_DESC
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_ADDRESS_DESC + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB
                + RISK_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + NRIC_ELDERLY_DESC_BOB + BIRTH_DATE_DESC_BOB + REGION_DESC_BOB
