...
public class MasterDeckParserTest {
    ...
    public void parseCommand_clear() throws Exception {
        assertTrue(parser.parseCommandInMainMode(ClearCommand.COMMAND_WORD) instanceof ClearCommand);
        assertTrue(parser.parseCommandInMainMode(ClearCommand.COMMAND_WORD
    ...
    public void parseCommand_exit() throws Exception {
        assertTrue(parser.parseCommandInMainMode(ExitCommand.COMMAND_WORD) instanceof ExitCommand);
        assertTrue(parser.parseCommandInMainMode(ExitCommand.COMMAND_WORD
    ...
    public void parseCommand_find() throws Exception {
        ...
        FindCommand command = (FindCommand) parser.parseCommandInMainMode(
    ...
    public void parseCommand_help() throws Exception {
        assertTrue(parser.parseCommandInMainMode(HelpCommand.COMMAND_WORD) instanceof HelpCommand);
        assertTrue(parser.parseCommandInMainMode(HelpCommand.COMMAND_WORD
                + " 3") instanceof HelpCommand);
    }

    @Test
    public void parseCommand_list() throws Exception {
        assertTrue(parser.parseCommandInMainMode(ListCommand.COMMAND_WORD) instanceof ListCommand);
        assertTrue(parser.parseCommandInMainMode(ListCommand.COMMAND_WORD
    ...
    public void parseCommand_unrecognisedInput_throwsParseException() {
        assertThrows(ParseException.class, String.format(MESSAGE_INVALID_COMMAND_FORMAT, HelpCommand.MESSAGE_USAGE), ()
            -> parser.parseCommandInMainMode(""));
    }

    @Test
    public void parseCommand_unknownCommand_throwsParseException() {
        assertThrows(ParseException.class, MESSAGE_UNKNOWN_COMMAND, ()
                -> parser.parseCommandInMainMode("unknownCommand"));
    }
}
