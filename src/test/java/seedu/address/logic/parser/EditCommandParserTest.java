...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_DATE_DESC + VALID_ADDRESS_AMY + VALID_POSTAL_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPostal(VALID_POSTAL_BOB).withDate(VALID_DATE_AMY).withAddress(VALID_ADDRESS_AMY)
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = targetIndex.getOneBased() + POSTAL_DESC_AMY + ADDRESS_DESC_AMY + DATE_DESC_AMY
                + TAG_DESC_FRIEND + POSTAL_DESC_AMY + ADDRESS_DESC_AMY + DATE_DESC_AMY + TAG_DESC_FRIEND
                + POSTAL_DESC_BOB + ADDRESS_DESC_BOB + DATE_DESC_BOB + TAG_DESC_HUSBAND;
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + DATE_DESC_BOB + INVALID_POSTAL_DESC + ADDRESS_DESC_BOB
                + POSTAL_DESC_BOB;
        descriptor = new EditPersonDescriptorBuilder().withPostal(VALID_POSTAL_BOB).withDate(VALID_DATE_BOB)
