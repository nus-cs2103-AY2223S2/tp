...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_EDUCATION_DESC;
...
public class EditCommandParserTest {
    ...
    private static final String MESSAGE_INVALID_FORMAT = Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
//        String userInput = targetIndex.getOneBased() + " p/22222222" + TAG_DESC_HUSBAND
//                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND
//                + EDUCATION_DESC_AMY + " tele/@amy123";
