...
public class ListCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, MODULE_CODE_DESC_2103, new ListCommand(new ModuleContainsKeywordsPredicate(VALID_MODULE_CODE_2103)));

        // Module code and lecture name is present
        assertParseSuccess(parser, MODULE_CODE_DESC_2103 + LECTURE_NAME_DESC_L1, new ListCommand(new ModuleLectureContainsKeywordsPredicate(VALID_MODULE_CODE_2103, VALID_LECTURE_NAME_L1)));
    }
