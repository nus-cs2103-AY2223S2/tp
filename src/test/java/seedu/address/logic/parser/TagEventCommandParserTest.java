...
class TagEventCommandParserTest {

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, TagEventCommand.MESSAGE_USAGE);

    private final TagEventCommandParser parser = new TagEventCommandParser();
    ...
    void parse_allFields_success() {
        TagEventCommand expectedCommand = new TagEventCommand(Index.fromZeroBased(0), new Name(VALID_NAME_AMY));
