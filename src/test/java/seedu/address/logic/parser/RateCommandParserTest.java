...
public class RateCommandParserTest {
    ...
    public void parse_validArgs_returnsRateCommand() {
        assertParseSuccess(parser, "1", new RateCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, RateCommand.MESSAGE_USAGE));
    }
}
