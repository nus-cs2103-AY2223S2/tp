...
public class TaskParserTest {
    ...
    public void parseTaskCommand_addTodo() throws Exception {
        InternshipTodo todo = new TodoBuilder().build();
        AddTodoCommand command = (AddTodoCommand) parser.parseTaskCommand(TodoUtil.getAddTodoCommand(todo));
    ...
    public void parseTaskCommand_addNote() throws Exception {
        ...
        AddNoteCommand command = (AddNoteCommand) parser.parseTaskCommand(NoteUtil.getAddTodoCommand(note));
    ...
    public void parseTaskCommand_deleteTodo() throws Exception {
        DeleteTodoCommand command = (DeleteTodoCommand) parser.parseTaskCommand(
                DeleteTodoCommand.COMMAND_WORD, " " + INDEX_FIRST_OBJECT.getOneBased());
        assertEquals(new DeleteTodoCommand(INDEX_FIRST_OBJECT), command);
    }
    ...
    public void parseTaskCommand_deleteNote() throws Exception {
        DeleteNoteCommand command = (DeleteNoteCommand) parser.parseTaskCommand(
                DeleteNoteCommand.COMMAND_WORD, " " + INDEX_FIRST_OBJECT.getOneBased());
        assertEquals(new DeleteNoteCommand(INDEX_FIRST_OBJECT), command);
    }
    ...
    public void parseTaskCommand_editDeadline() throws Exception {
        ...
        EditDeadlineCommand command = (EditDeadlineCommand) parser.parseTaskCommand(EditDeadlineCommand.COMMAND_WORD,
                " 2023-07-09");
        assertEquals(new EditDeadlineCommand(INDEX_FIRST_OBJECT, deadline), command);
    }
    ...
    public void parseTaskCommand_editNoteContent() throws Exception {
        ...
        EditNoteContentCommand command = (EditNoteContentCommand) parser.parseTaskCommand(
                EditNoteContentCommand.COMMAND_WORD, " Test case");
        assertEquals(new EditNoteContentCommand(INDEX_FIRST_OBJECT, note), command);
    }
