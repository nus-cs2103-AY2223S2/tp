...
public class EditElderlyCommandParserTest {

    private static final String TAG_EMPTY = " " + PREFIX_TAG;

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditElderlyCommand.MESSAGE_USAGE);

    private EditElderlyCommandParser parser = new EditElderlyCommandParser();
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditElderlyDescriptor descriptor = new EditElderlyDescriptorBuilder()
                ...
                .withRegion(VALID_REGION_AMY).withRiskLevel(VALID_RISKLEVEL_AMY)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        EditElderlyDescriptor descriptor = new EditElderlyDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditElderlyCommand expectedCommand = new EditElderlyCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        // nric
        userInput = targetIndex.getOneBased() + NRIC_ELDERLY_DESC_AMY;
        descriptor = new EditElderlyDescriptorBuilder().withNric(VALID_NRIC_AMY).build();
        expectedCommand = new EditElderlyCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        descriptor = new EditElderlyDescriptorBuilder().withTags(VALID_TAG_STRONG).build();
        expectedCommand = new EditElderlyCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PHONE_DESC + ADDRESS_DESC_BOB
                + PHONE_DESC_BOB;
        descriptor = new EditElderlyDescriptorBuilder().withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
    ...
    public void parse_resetTags_success() {
        ...
        EditElderlyDescriptor descriptor = new EditElderlyDescriptorBuilder().withTags().build();
        EditElderlyCommand expectedCommand = new EditElderlyCommand(targetIndex, descriptor);
