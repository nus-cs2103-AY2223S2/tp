...
public class AddPatientCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Patient expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).buildPatient();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + NRIC_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddPatientCommand(expectedPerson));
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Patient expectedPerson = new PersonBuilder(AMY).withTags().buildPatient();
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + NRIC_DESC_AMY
                + ADDRESS_DESC_AMY, new AddPatientCommand(expectedPerson));
    }
