...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Tutee expectedTutee = new TuteeTestBuilder(BOB).withTags(TAG_DESC_EFFORT).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SUBJECT_DESC_BOB + SCHEDULE_DESC_BOB
                + STARTTIME_DESC_BOB + ENDTIME_DESC_BOB + TAG_DESC_EFFORT, new AddCommand(expectedTutee));
        ...
        Tutee expectedTuteeMultipleTags = new TuteeTestBuilder(BOB).withTags(TAG_DESC_EFFORT, TAG_DESC_QUICK)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SUBJECT_DESC_BOB + SCHEDULE_DESC_BOB + STARTTIME_DESC_BOB + ENDTIME_DESC_BOB
                + TAG_DESC_EFFORT + TAG_DESC_QUICK, new AddCommand(expectedTuteeMultipleTags));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SUBJECT_DESC_BOB + SCHEDULE_DESC_BOB + STARTTIME_DESC_BOB + ENDTIME_DESC_BOB
                + TAG_DESC_EFFORT + TAG_DESC_QUICK, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SUBJECT_DESC_BOB + SCHEDULE_DESC_BOB + STARTTIME_DESC_BOB + ENDTIME_DESC_BOB
                + TAG_DESC_EFFORT + TAG_DESC_QUICK, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + SUBJECT_DESC_BOB + SCHEDULE_DESC_BOB + STARTTIME_DESC_BOB + ENDTIME_DESC_BOB
                + TAG_DESC_EFFORT + TAG_DESC_QUICK, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + SUBJECT_DESC_BOB + SCHEDULE_DESC_BOB + STARTTIME_DESC_BOB + ENDTIME_DESC_BOB
                + TAG_DESC_EFFORT + TAG_DESC_QUICK, Address.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SUBJECT_DESC_BOB + SCHEDULE_DESC_BOB + STARTTIME_DESC_BOB + ENDTIME_DESC_BOB
                + INVALID_TAG_DESC + TAG_DESC_EFFORT, Tag.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SUBJECT_DESC_BOB + SCHEDULE_DESC_BOB + STARTTIME_DESC_BOB + ENDTIME_DESC_BOB
                        + TAG_DESC_EFFORT + TAG_DESC_QUICK,
