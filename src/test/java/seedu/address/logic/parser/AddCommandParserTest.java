...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, TANK_DESC + NAME_DESC_BOB + LAST_FED_DATE_DESC_BOB + SPECIES_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, TANK_DESC + NAME_DESC_AMY + LAST_FED_DATE_DESC_AMY + SPECIES_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, TANK_DESC + VALID_NAME_BOB + LAST_FED_DATE_DESC_AMY + SPECIES_DESC_BOB
                        + ADDRESS_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, TANK_DESC + NAME_DESC_BOB + LAST_FED_DATE_DESC_AMY + VALID_SPECIES_BOB
                        + ADDRESS_DESC_BOB, expectedMessage);

        // missing address prefix
        assertParseFailure(parser, TANK_DESC + NAME_DESC_BOB + LAST_FED_DATE_DESC_AMY + SPECIES_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, TANK_DESC + INVALID_NAME_DESC + LAST_FED_DATE_DESC_BOB + SPECIES_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid LastFedDate
        assertParseFailure(parser, TANK_DESC + NAME_DESC_BOB + INVALID_LAST_FED_DATE_DESC + SPECIES_DESC_BOB
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + TANK_DESC + NAME_DESC_BOB + LAST_FED_DATE_DESC_BOB
                + SPECIES_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
