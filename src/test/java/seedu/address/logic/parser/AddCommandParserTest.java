...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withGroupTags(CommandTestUtil.VALID_TAG_FRIEND).build();
        ...
        assertParseSuccess(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.NAME_DESC_BOB
                ...
                + CommandTestUtil.ADDRESS_DESC_BOB + CommandTestUtil.TELEGRAM_DESC_BOB
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB)
                .withGroupTags(CommandTestUtil.VALID_TAG_FRIEND, CommandTestUtil.VALID_TAG_HUSBAND)
                .build();
        assertParseSuccess(parser, CommandTestUtil.NAME_DESC_BOB + CommandTestUtil.PHONE_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Person expectedPerson = new PersonBuilder(AMY).withGroupTags().build();
        System.out.println(expectedPerson);
        System.out.println(new AddCommand(expectedPerson).toString());
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, CommandTestUtil.NAME_DESC_BOB + CommandTestUtil.PHONE_DESC_BOB
                + CommandTestUtil.EMAIL_DESC_BOB + CommandTestUtil.ADDRESS_DESC_BOB
                + CommandTestUtil.TELEGRAM_DESC_BOB
                + CommandTestUtil.INVALID_TAG_DESC + CommandTestUtil.VALID_TAG_FRIEND, GroupTag.MESSAGE_CONSTRAINTS);
