...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Student expectedStudent = new StudentBuilder(BOB).withTags(VALID_TAG_CS2103).build();
        ...
        Student expectedStudentMultipleTags = new StudentBuilder(BOB).withTags(VALID_TAG_CS2103, VALID_TAG_CS2105)
                .build();
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + STUDENTID_DESC_BOB
                + INVALID_TAG_DESC + VALID_TAG_CS2103, Tag.MESSAGE_CONSTRAINTS);
