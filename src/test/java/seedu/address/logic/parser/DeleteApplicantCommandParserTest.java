...
public class DeleteApplicantCommandParserTest {
    ...
    public void parse_invalidId_failure() {
        assertParseFailure(parser, "1 " + INVALID_ID_WITH_HASHCODE_DESC, MESSAGE_INVALID_FORMAT);
        assertParseFailure(parser, "1 " + INVALID_ID_WITHOUT_HASHCODE_DESC, MESSAGE_INVALID_FORMAT);
    }
}
