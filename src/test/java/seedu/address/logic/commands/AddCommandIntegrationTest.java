...
public class AddCommandIntegrationTest {
    ...
    public void execute_newPerson_success() {
        seedu.address.model.student.Student validStudent = new seedu.address.testutil.StudentBuilder().build();
    ...
    public void execute_duplicatePerson_throwsCommandException() {
        seedu.address.model.student.Student studentInList = model.getAddressBook().getPersonList().get(0);
