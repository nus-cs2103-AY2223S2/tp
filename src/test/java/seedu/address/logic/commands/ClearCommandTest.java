...
/*
    ...
    public void execute_nonEmptyAddressBook_success() {
        ...
        CommandResult result = clearCommand.getResultString(model, true);
    ...
    public void execute_nonEmptyAddressBook_cancel() {
        ...
        ClearCommand clearCommand = new ClearCommand();
        CommandResult result = clearCommand.getResultString(model, false);

        assertCommandSuccess(result, model, ClearCommand.MESSAGE_FAILED, expectedModel);
    }
*/
}
