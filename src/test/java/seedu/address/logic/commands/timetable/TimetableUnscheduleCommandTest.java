...
public class TimetableUnscheduleCommandTest {
    private Model model;
    ...
    public void execute_focusDateIsUpdated() {
        assertCommandSuccess(new TimetableUnscheduleCommand(),
                model, TimetableUnscheduleCommand.MESSAGE_SUCCESS, expectedModel);
    }
}
