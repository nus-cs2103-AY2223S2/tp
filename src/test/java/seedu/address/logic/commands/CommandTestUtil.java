...
public class CommandTestUtil {
    ...
    public static final String VALID_GROUP = "CS2103";
    ...
    public static final String GROUP_DESC_2103T = " " + PREFIX_GROUP + VALID_GROUP;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withGroups(VALID_GROUP).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withGroups(VALID_GROUP).build();
    }
