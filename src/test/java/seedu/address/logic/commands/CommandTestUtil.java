...
public class CommandTestUtil {
    ...
    public static final String VALID_ID_AMY = "001";
    public static final String VALID_ID_BOB = "002";
    ...
    public static final String VALID_REMARK_AMY = "Amy is a teacher.";
    public static final String VALID_REMARK_BOB = "Bob builds.";
