...
public class CommandTestUtil {
    ...
    public static final String VALID_EDUCATION_AMY = "JC 1";
    ...
    public static final String VALID_TELEGRAM_ALICE = "@alice123";
    ...
    public static final String MODULE_DESC_AMY = " " + PREFIX_MODULE + VALID_MODULE_CS2103T;
    public static final String MODULE_DESC_BOB = " " + PREFIX_MODULE + VALID_MODULE_CS2030 + " "
            + PREFIX_MODULE + VALID_MODULE_CS2103T;
    public static final String TAG_DESC_FRIEND = " " + PREFIX_TAG + VALID_TAG_FRIEND;
    public static final String TAG_DESC_HUSBAND = " " + PREFIX_TAG + VALID_TAG_HUSBAND;
    public static final String TELEGRAM_DESC_ALICE = " " + PREFIX_TELEGRAM + VALID_TELEGRAM_ALICE;
    ...
    public static final String INVALID_EDUCATION_DESC = " " + PREFIX_EMAIL + "#P6"; // '#' not allowed in edu
    public static final String INVALID_MODULE_DESC = " " + PREFIX_MODULE + "math()"; // () not allowed in module
    public static final String INVALID_TAG_DESC = " " + PREFIX_TAG + "hubby*"; // '*' not allowed in tags
    public static final String INVALID_TELEGRAM_DESC = " " + PREFIX_TELEGRAM + "hello"; // @ must be included in tele
    ...
    public static final String VALID_REMARK = "Hello";

    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).withEducation(EDUCATION_DESC_AMY).withModules(MODULE_DESC_AMY)
                .withTelegram(TELEGRAM_DESC_ALICE).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withEducation(EDUCATION_DESC_BOB).withModules(MODULE_DESC_BOB).withTelegram(TELEGRAM_DESC_BOB)
