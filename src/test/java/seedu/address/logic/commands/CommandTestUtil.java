...
public class CommandTestUtil {
    ...
    public static final String VALID_RESUME_LINK_BANK_OF_AMERICA = "https://drive.example.com/resume_boa";
    public static final String VALID_RESUME_LINK_META = "https://drive.example.com/resume_meta";
    public static final String VALID_COVER_LETTER_LINK_BANK_OF_AMERICA = "https://drive.example.com/coverletter_boa";
    public static final String VALID_COVER_LETTER_LINK_META = "https://drive.example.com/coverletter_meta";
