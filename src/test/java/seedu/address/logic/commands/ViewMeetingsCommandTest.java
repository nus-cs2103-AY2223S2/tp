...
public class ViewMeetingsCommandTest {
    ...
    public void execute_listIsNotFiltered_showsSameList() {
        String expected = "Dinner with Alice\n" +
                ...
                "At: 01/02/2023 19:00\n" +
                "Attendees: [Alice Pauline; Phone: 94351253; Email: alice@example.com; Address: 123, Jurong West Ave 6, #08-111; Tags: [friends]]\n" +
                "Location: NUS\n\n" +
                "" +
                "Study session with Benson and Carl\n" +
                "Description: Study for finals\n" +
                "At: 02/03/2023 15:00\n" +
                "Attendees: [Carl Kurz; Phone: 95352563; Email: heinz@example.com; Address: wall street, Benson Meier; Phone: 98765432; Email: johnd@example.com; Address: 311, Clementi Ave 2, #02-25; Tags: [owesMoney][friends]]\n" +
        ...
        assertCommandSuccess(new ViewMeetingsCommand(), model, expected, expectedModel);
    }
}
