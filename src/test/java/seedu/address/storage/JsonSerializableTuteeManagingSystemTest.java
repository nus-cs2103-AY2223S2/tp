...
public class JsonSerializableTuteeManagingSystemTest {
    ...
    private static final Path TYPICAL_PERSONS_FILE =
        TEST_DATA_FOLDER.resolve("typicalPersonsTuteeManagingSystem.json");

    private static final Path INVALID_PERSON_FILE =
        TEST_DATA_FOLDER.resolve("invalidPersonTuteeManagingSystem.json");

    private static final Path DUPLICATE_PERSON_FILE =
        TEST_DATA_FOLDER.resolve("duplicatePersonTuteeManagingSystem.json");
