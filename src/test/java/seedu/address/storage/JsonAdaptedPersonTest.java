...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, INVALID_GENDER, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_COMPANY, INVALID_INDUSTRY, INVALID_OCCUPATION, INVALID_JOBTITLE,
