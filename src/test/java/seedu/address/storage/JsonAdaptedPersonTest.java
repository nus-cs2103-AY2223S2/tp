...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
            VALID_SOCIALMEDIA, VALID_TAGS, VALID_BIRTHDAY);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, invalidPhone, VALID_EMAIL,
            VALID_ADDRESS, VALID_SOCIALMEDIA, VALID_TAGS, VALID_BIRTHDAY);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, invalidEmail,
            VALID_ADDRESS, VALID_SOCIALMEDIA, VALID_TAGS, VALID_BIRTHDAY);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
            VALID_SOCIALMEDIA, invalidTags, VALID_BIRTHDAY);
    ...
    public void toModelType_invalidBirthday_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_SOCIALMEDIA, VALID_TAGS, invalidBirthday);
