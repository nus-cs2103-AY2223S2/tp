...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullUnit_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_RANK, null, VALID_COMPANY, VALID_PLATOON, VALID_TAGS);
    ...
    public void toModelType_nullCompany_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_RANK, VALID_UNIT, null, VALID_PLATOON, VALID_TAGS);
    ...
    public void toModelType_nullPlatoon_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_RANK, VALID_UNIT, VALID_COMPANY, null, VALID_TAGS);
