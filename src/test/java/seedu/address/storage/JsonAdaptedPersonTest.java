...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_HAS_PAID = "false";
    private static final String VALID_IS_PRESENT = "false";
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_ADDRESS,
                        VALID_PAY_RATE, VALID_SESSION, VALID_IS_PRESENT, VALID_HAS_PAID, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, null,
                VALID_ADDRESS, VALID_PAY_RATE, VALID_SESSION, VALID_IS_PRESENT, VALID_HAS_PAID, VALID_TAGS);
    ...
    public void toModelType_invalidPayRate_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE,
                        VALID_ADDRESS, INVALID_PAY_RATE, VALID_SESSION, VALID_IS_PRESENT, VALID_HAS_PAID, VALID_TAGS);
    ...
    public void toModelType_nullPayRate_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_ADDRESS,
                null, VALID_SESSION, VALID_IS_PRESENT, VALID_HAS_PAID, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE,
                        INVALID_ADDRESS, VALID_PAY_RATE, VALID_SESSION, VALID_IS_PRESENT, VALID_HAS_PAID, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_PHONE, null, VALID_PAY_RATE, VALID_SESSION, VALID_IS_PRESENT, VALID_HAS_PAID, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE,
                        VALID_ADDRESS, VALID_PAY_RATE, VALID_SESSION, VALID_IS_PRESENT, VALID_HAS_PAID, invalidTags);
    ...
    public void toModelType_invalidSession_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                ...
                "invalid", VALID_IS_PRESENT, VALID_HAS_PAID, VALID_TAGS);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
