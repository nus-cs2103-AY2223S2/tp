...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_NAME = BENSON.getName().getValue();
    private static final String VALID_PHONE = BENSON.getPhone().getValue();
    private static final String VALID_EMAIL = BENSON.getEmail().getValue();
