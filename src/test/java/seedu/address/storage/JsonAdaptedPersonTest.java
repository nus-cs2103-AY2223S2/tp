...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC, VALID_ADDRESS,
                        VALID_MEDICATION, VALID_TAGS, VALID_APPOINTMENTS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                VALID_ADDRESS, VALID_MEDICATION, VALID_TAGS, VALID_APPOINTMENTS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                        INVALID_ADDRESS, VALID_MEDICATION, VALID_TAGS, VALID_APPOINTMENTS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                null, VALID_MEDICATION, VALID_TAGS, VALID_APPOINTMENTS);
    ...
    public void toModelType_invalidMedication_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                VALID_ADDRESS, INVALID_MEDICATION, VALID_TAGS, VALID_APPOINTMENTS);
    ...
    public void toModelType_nullMedication_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                VALID_ADDRESS, null, VALID_TAGS, VALID_APPOINTMENTS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NRIC,
                        VALID_ADDRESS, VALID_MEDICATION, invalidTags, VALID_APPOINTMENTS);
