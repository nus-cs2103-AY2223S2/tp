    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_REMARK,
                        VALID_SUBJECT, VALID_SCHEDULE, VALID_STARTTIME, VALID_ENDTIME, VALID_TAGS, VALID_ATTENDANCE);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_REMARK,
                        VALID_SUBJECT, VALID_SCHEDULE, VALID_STARTTIME, VALID_ENDTIME, invalidTags, VALID_ATTENDANCE);
