...
public class JsonAdaptedTuteeTest {
    ...
    private static final String INVALID_STARTTIME = "two thirty";
    private static final String INVALID_ENDTIME = "4.30";
    ...
    private static final String VALID_ENDTIME = BENSON.getEndTime().toString();
    ...
    private static final List<LocalDate> VALID_ATTENDANCE = BENSON.getAttendance()
        .stream()
        .collect(Collectors.toList());
    private static final List<String> VALID_LESSON = BENSON.getLessons()
            .stream()
            .collect(Collectors.toList());
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_REMARK,
                        VALID_SUBJECT, VALID_SCHEDULE, VALID_STARTTIME, VALID_ENDTIME, VALID_TAGS, VALID_ATTENDANCE, VALID_LESSON);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_REMARK,
                        VALID_SUBJECT, VALID_SCHEDULE, VALID_STARTTIME, VALID_ENDTIME, invalidTags, VALID_ATTENDANCE, VALID_LESSON);
