...
public class JsonFriendlyLinkStorageTest {
    ...
    private java.util.Optional<ReadOnlyFriendlyLink> readFriendlyLink(String filePath) throws Exception {
        return new JsonFriendlyLinkStorage(Paths.get(filePath))
                .readFriendlyLink(addToTestDataPathIfNotNull(filePath), new FriendlyLink());
    }
    ...
    public void readAndSaveFriendlyLink_allInOrder_success() throws Exception {
        ...
        ReadOnlyFriendlyLink readBack = jsonFriendlyLinkStorage.readFriendlyLink(filePath, new FriendlyLink()).get();
        ...
        jsonFriendlyLinkStorage.saveFriendlyLink(original, filePath);
        readBack = jsonFriendlyLinkStorage.readFriendlyLink(filePath, new FriendlyLink()).get();
        assertEquals(original, new FriendlyLink(readBack));

        // Save and read without specifying file path
        original.addPerson(IDA);
        jsonFriendlyLinkStorage.saveFriendlyLink(original); // file path not specified
        readBack = jsonFriendlyLinkStorage.readFriendlyLink(new FriendlyLink()).get(); // file path not specified
        assertEquals(original, new FriendlyLink(readBack));
