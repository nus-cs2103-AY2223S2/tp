...
//import static seedu.wife.logic.commands.itemcommands.NewCommandTest.ModelStub;
...
//import seedu.wife.viewmodels.TagsWithMessage;
//
///**
...
//
//        CommandResult<TagsWithMessage> commandResult = new AddTagCommand(validTag).execute(modelStub);
//
//        TagsWithMessage expectedOutput = new TagsWithMessage(EXPECTED_SUCCESS_MESSAGE, validTag);
