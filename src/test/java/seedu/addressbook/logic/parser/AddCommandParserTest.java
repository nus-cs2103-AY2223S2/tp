...
import static seedu.addressbook.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.APPOINTMENT_DESC_DATE_ONE;
import static seedu.addressbook.logic.commands.CommandTestUtil.APPOINTMENT_DESC_DATE_TWO;
import static seedu.addressbook.logic.commands.CommandTestUtil.CALORIE_DESC_AMY;
import static seedu.addressbook.logic.commands.CommandTestUtil.CALORIE_DESC_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static seedu.addressbook.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.GENDER_DESC_AMY;
import static seedu.addressbook.logic.commands.CommandTestUtil.GENDER_DESC_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_APPOINTMENT_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_CALORIE_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_GENDER_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.INVALID_WEIGHT_DESC;
import static seedu.addressbook.logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static seedu.addressbook.logic.commands.CommandTestUtil.NAME_DESC_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static seedu.addressbook.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.PREAMBLE_NON_EMPTY;
import static seedu.addressbook.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
import static seedu.addressbook.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.addressbook.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_ADDRESS_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_APPOINTMENT_DATE_ONE;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_APPOINTMENT_DATE_TWO;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_CALORIE_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_EMAIL_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_NAME_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_PHONE_BOB;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_TAG_FRIEND;
import static seedu.addressbook.logic.commands.CommandTestUtil.VALID_TAG_HUSBAND;
import static seedu.addressbook.logic.commands.CommandTestUtil.WEIGHT_DESC_AMY;
import static seedu.addressbook.logic.commands.CommandTestUtil.WEIGHT_DESC_BOB;
import static seedu.addressbook.logic.parser.CommandParserTestUtil.assertParseFailure;
import static seedu.addressbook.logic.parser.CommandParserTestUtil.assertParseSuccess;
import static seedu.addressbook.testutil.TypicalClients.AMY;
import static seedu.addressbook.testutil.TypicalClients.BOB;

import org.junit.jupiter.api.Test;

import seedu.addressbook.logic.commands.AddCommand;
import seedu.addressbook.model.client.Address;
import seedu.addressbook.model.client.Appointment;
import seedu.addressbook.model.client.Calorie;
import seedu.addressbook.model.client.Client;
import seedu.addressbook.model.client.Email;
import seedu.addressbook.model.client.Name;
import seedu.addressbook.model.client.Phone;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + WEIGHT_DESC_BOB + GENDER_DESC_BOB + APPOINTMENT_DESC_DATE_ONE,
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + WEIGHT_DESC_BOB + GENDER_DESC_AMY + GENDER_DESC_BOB,
                new AddCommand(expectedClient));
