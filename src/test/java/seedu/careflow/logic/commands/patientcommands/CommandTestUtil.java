...
public class CommandTestUtil {
    ...
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for careflowes

    public static final String PREAMBLE_WHITESPACE = "\t  \r  \n";
    public static final String PREAMBLE_NON_EMPTY = "NonEmptyPreamble";

    public static final UpdateCommand.EditPatientDescriptor DESC_AMY;
    public static final UpdateCommand.EditPatientDescriptor DESC_BOB;
