...
public class TypicalDrugs {
    public static final Drug PROZAC = new DrugBuilder().withTradeName("Prozac").withActiveIngredient("Fluoxetine " +
            ...
            "nausea, vomiting, diarrhea, dry mouth, headache, dizziness, and nervousness.").withStorageCount("10").build();
    public static final Drug ROBITUSSIN = new DrugBuilder().withTradeName("Robitussin").withActiveIngredient(
            ...
            "suppressant that is used to treat coughs caused by the common cold or other respiratory illnesses.")
    ...
    public static final Drug SUDAFED = new DrugBuilder().withTradeName("Sudafed").withActiveIngredient(
            ...
            "hours, up to a maximum of 240 mg per day.").withPurpose("Sudafed is a decongestant that is used to treat" +
            " nasal congestion and a runny nose caused by allergies, the common cold, or other respiratory illnesses.")
    ...
    public static final Drug METFORMIN = new DrugBuilder().withTradeName("Metformin").withActiveIngredient("Metformin" +
            ...
            "500mg-1000mg taken twice daily with meals.").withPurpose("Metformin is an oral medication used to manage" +
            " type 2 diabetes by helping to control blood sugar levels.").withSideEffect("Common side effects of " +
            "Metformin may include diarrhea, nausea, vomiting, abdominal pain, and a metallic taste in the mouth.")
