...
class JsonAdaptedProjectTest {
    ...
    private static final String INVALID_PROJECT_MEETING = " ";
    ...
    private static final String VALID_PROJECT_MEETING = ALPHA.getMeeting().toString();
    ...
    public void toModelType_invalidProjectName_throwsIllegalValueException() {
        JsonAdaptedProject project =
                ...
                VALID_PROJECT_DEADLINE, VALID_PROJECT_MEETING, VALID_PERSONS);
    ...
    public void toModelType_invalidProjectDeadline_throwsIllegalValueException() {
        JsonAdaptedProject project =
                new JsonAdaptedProject(VALID_PROJECT_NAME, VALID_PROJECT_REPO_HOST, VALID_PROJECT_REPO_NAME,
                        INVALID_PROJECT_DEADLINE, VALID_PROJECT_MEETING, VALID_PERSONS);
    ...
    public void toModelType_nullProjectDeadline_throwsIllegalValueException() {
        JsonAdaptedProject project =
                new JsonAdaptedProject(VALID_PROJECT_NAME, VALID_PROJECT_REPO_HOST, VALID_PROJECT_REPO_NAME,
                        null, VALID_PROJECT_MEETING, VALID_PERSONS);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, ProjectDeadline.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, project::toModelType);
    }

    @Test
    public void toModelType_invalidProjectMeeting_throwsIllegalValueException() {
        JsonAdaptedProject project =
                new JsonAdaptedProject(VALID_PROJECT_NAME, VALID_PROJECT_REPO_HOST, VALID_PROJECT_REPO_NAME,
                        VALID_PROJECT_DEADLINE, INVALID_PROJECT_MEETING, VALID_PERSONS);
        String expectedMessage = ProjectDeadline.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, project::toModelType);
    }

    @Test
    public void toModelType_nullProjectMeeting_throwsIllegalValueException() {
        JsonAdaptedProject project =
                new JsonAdaptedProject(VALID_PROJECT_NAME, VALID_PROJECT_REPO_HOST, VALID_PROJECT_REPO_NAME,
                        VALID_PROJECT_DEADLINE, null, VALID_PERSONS);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, ProjectMeeting.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, project::toModelType);
    }
}
