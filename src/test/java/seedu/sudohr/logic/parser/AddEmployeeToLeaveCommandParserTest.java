...
public class AddEmployeeToLeaveCommandParserTest {
    private AddEmployeeToLeaveCommandParser parser = new AddEmployeeToLeaveCommandParser();

    @Test
    public void parse_allFieldsPresent_success() {
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + EMPLOYEE_INDEX_DESC_1 + DATE_DESC_LEAVE_TYPE_1,
                new AddEmployeeToLeaveCommand(Index.fromOneBased(1), new LeaveDate(LocalDate.parse(
