...
public class CommandTestUtil {
    ...
    public static final String PID_DESC_AMY = " " + PREFIX_PID + VALID_PID_AMY;
    public static final String PID_DESC_BOB = " " + PREFIX_PID + VALID_PID_BOB;
    ...
    public static final String INVALID_PID_DESC = " " + PREFIX_PID + "12345"; // PID needs to start and end with letters
