...
public class UpdateWardParserTest {

    private UpdateWardParser parser = new UpdateWardParser();

    @Test
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "2 w/Block A Ward 2",
                new UpdateWardCommand(INDEX_SECOND_PERSON, "Block A Ward 2"));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a w/Block A Ward 2",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, UpdateWardCommand.MESSAGE_USAGE));
    }
