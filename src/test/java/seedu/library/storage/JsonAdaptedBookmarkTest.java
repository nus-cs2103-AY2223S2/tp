...
public class JsonAdaptedBookmarkTest {
    ...
    public void toModelType_invalidTitle_throwsIllegalValueException() {
        JsonAdaptedBookmark bookmark =
                new JsonAdaptedBookmark(INVALID_TITLE, VALID_PROGRESS, VALID_GENRE,
                        VALID_AUTHOR, VALID_TAGS);
    ...
    public void toModelType_invalidGenre_throwsIllegalValueException() {
        JsonAdaptedBookmark bookmark =
                new JsonAdaptedBookmark(VALID_TITLE, VALID_PROGRESS, INVALID_GENRE,
                        VALID_AUTHOR, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedBookmark bookmark =
                new JsonAdaptedBookmark(VALID_TITLE, VALID_PROGRESS, VALID_GENRE,
                        VALID_AUTHOR, invalidTags);
