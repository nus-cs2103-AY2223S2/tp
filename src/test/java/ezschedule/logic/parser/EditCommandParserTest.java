...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_START_TIME_DESC, Time.MESSAGE_CONSTRAINTS); // invalid start time
        assertParseFailure(parser, "1" + INVALID_END_TIME_DESC, Time.MESSAGE_CONSTRAINTS); // invalid end time
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + DATE_DESC_B
                + NAME_DESC_A + START_TIME_DESC_A + END_TIME_DESC_A;

        EditEventDescriptor descriptor = new EditEventDescriptorBuilder().withName(VALID_NAME_A)
                .withDate(VALID_DATE_B).withStartTime(VALID_START_TIME_A).withEndTime(VALID_END_TIME_A).build();
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + DATE_DESC_B + START_TIME_DESC_A;
