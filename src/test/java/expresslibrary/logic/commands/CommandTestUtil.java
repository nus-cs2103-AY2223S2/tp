...
public class CommandTestUtil {
    ...
    public static final String VALID_BOOK_AMY = "manga";
    public static final String VALID_BOOK_BOB = "comic";
    ...
    public static final String BOOK_DESC_AMY = " " + PREFIX_BOOK + VALID_BOOK_AMY;
    public static final String BOOK_DESC_BOB = " " + PREFIX_BOOK + VALID_BOOK_BOB;
    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + "James&"; // '&' not allowed in names
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for addresses
    public static final String INVALID_TAG_DESC = " " + PREFIX_TAG + "hubby*"; // '*' not allowed in tags
    public static final String INVALID_BOOK_DESC = " " + PREFIX_BOOK; // empty string not allowed for books
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withBook(VALID_BOOK_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withBook(VALID_BOOK_BOB).build();
    }
