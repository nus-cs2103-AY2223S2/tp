...
import static expresslibrary.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
//import static expresslibrary.logic.commands.CommandTestUtil.BOOK_DESC_AMY;
import static expresslibrary.logic.commands.CommandTestUtil.BOOK_DESC_BOB;
...
import static expresslibrary.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static expresslibrary.logic.commands.CommandTestUtil.INVALID_BOOK_DESC;
...
import static expresslibrary.logic.commands.CommandTestUtil.VALID_BOOK_BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        ////        + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + BOOK_DESC_BOB, new AddCommand(expectedPerson));
        //
        ...
        //        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + BOOK_DESC_BOB, new AddCommand(expectedPersonMultipleTags));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        //assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + BOOK_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + VALID_BOOK_BOB, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + BOOK_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + BOOK_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + BOOK_DESC_BOB, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + BOOK_DESC_BOB, Address.MESSAGE_CONSTRAINTS);

        // invalid book
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + INVALID_BOOK_DESC, Book.MESSAGE_CONSTRAINTS);

        // invalid tag
        // will fix later
        //assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
        //        + INVALID_TAG_DESC + VALID_TAG_FRIEND + BOOK_DESC_BOB, Tag.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + BOOK_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + BOOK_DESC_BOB,
