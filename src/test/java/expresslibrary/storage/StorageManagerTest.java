...
public class StorageManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonExpressLibraryStorage expressLibraryStorage = new JsonExpressLibraryStorage(getTempFilePath("ab"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(getTempFilePath("prefs"));
        storageManager = new StorageManager(expressLibraryStorage, userPrefsStorage);
    }
    ...
    @Test
    public void expressLibraryReadSave() throws Exception {
        /*
         * Note: This is an integration test that verifies the StorageManager is
         * properly wired to the
         * {@link JsonExpressLibraryStorage} class.
         * More extensive testing of UserPref saving/reading is done in {@link
    ...
    @Test
    public void getExpressLibraryFilePath() {
        assertNotNull(storageManager.getExpressLibraryFilePath());
    }
