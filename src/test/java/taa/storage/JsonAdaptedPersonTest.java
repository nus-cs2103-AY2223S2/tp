...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(INVALID_NAME, Attendance.ORIGINAL_ATD,
                Attendance.ORIGINAL_PP, VALID_TAGS, VALID_SUBIT_STRS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(null, Attendance.ORIGINAL_ATD, Attendance.ORIGINAL_PP,
                VALID_TAGS, VALID_SUBIT_STRS);
