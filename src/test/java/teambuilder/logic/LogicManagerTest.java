...
import static teambuilder.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
import static teambuilder.commons.core.Messages.MESSAGE_UNKNOWN_COMMAND;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTeamBuilderStorage addressBookStorage =
                new JsonTeamBuilderStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        Model expectedModel = new ModelManager(model.getTeamBuilder(), new UserPrefs());
     ...
     */
    private static class JsonAddressBookIoExceptionThrowingStub extends JsonTeamBuilderStorage {
