...
public class JsonSerializableTeamBuilderTest {
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        JsonSerializableTeamBuilder dataFromFile = JsonUtil
                .readJsonFile(TYPICAL_PERSONS_FILE, JsonSerializableTeamBuilder.class).get();
    ...
    public void toModelType_invalidPersonFile_throwsIllegalValueException() throws Exception {
        JsonSerializableTeamBuilder dataFromFile = JsonUtil
                .readJsonFile(INVALID_PERSON_FILE, JsonSerializableTeamBuilder.class).get();
    ...
    public void toModelType_duplicatePersons_throwsDuplicatePersonException() throws Exception {
        JsonSerializableTeamBuilder dataFromFile = JsonUtil
                .readJsonFile(DUPLICATE_PERSON_FILE, JsonSerializableTeamBuilder.class).get();
