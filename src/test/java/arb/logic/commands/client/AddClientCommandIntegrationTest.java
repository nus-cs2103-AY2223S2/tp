...
public class AddClientCommandIntegrationTest {
    ...
    public void execute_newClient_success() {
        ...
        assertCommandSuccess(new AddClientCommand(validClient), ListType.CLIENT, model,
    ...
    public void execute_duplicateClient_throwsCommandException() {
        ...
        assertCommandFailure(new AddClientCommand(clientInList), ListType.CLIENT, model, AddClientCommand.MESSAGE_DUPLICATE_CLIENT);
    }
