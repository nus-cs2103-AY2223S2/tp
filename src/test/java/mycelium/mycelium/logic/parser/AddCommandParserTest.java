...
import static mycelium.mycelium.logic.commands.CommandTestUtil.NAME_DESC_BOB;
...
import static mycelium.mycelium.logic.commands.CommandTestUtil.PREAMBLE_NON_EMPTY;
import static mycelium.mycelium.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(TypicalEntities.BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Person
            ...
            new PersonBuilder(TypicalEntities.BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Person expectedPerson = new PersonBuilder(TypicalEntities.AMY).withTags().build();
