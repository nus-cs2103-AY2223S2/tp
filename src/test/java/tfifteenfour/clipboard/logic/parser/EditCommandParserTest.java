...
//        assertParseFailure(parser, "1" + TAG_DESC_TEAM1 + TAG_EMPTY, Tag.MESSAGE_CONSTRAINTS);
...
//                .withTags(VALID_MODULE_CS2105, VALID_MODULE_CS2103).build();
...
//
//        // tags
//        userInput = targetIndex.getOneBased() + MODULE_DESC_CS2105;
//        descriptor = new EditStudentDescriptorBuilder().withTags(VALID_MODULE_CS2103).build();
//        expectedCommand = new EditCommand(targetIndex, descriptor);
//        assertParseSuccess(parser, userInput, expectedCommand);
//    }
//
...
//        Index targetIndex = INDEX_FIRST_PERSON;
//        String userInput = targetIndex.getOneBased() + PHONE_DESC//package seedu.address.logic.parser;
////
////import static seedu.address.commons.core.Messages.MESSAGE_INVALID_COMMAND_FORMAT;
////import static seedu.address.logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
////import static seedu.address.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
...
////                + MODULE_DESC_CS2105 + PHONE_DESC_AMY + STUDENTID_DESC_AMY + EMAIL_DESC_AMY + MODULE_DESC_CS2105
////                + PHONE_DESC_BOB + STUDENTID_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_TEAM1 + TAG_DESC_TEAM2;
////
////        EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder().withPhone(VALID_PHONE_BOB)
////                .withEmail(VALID_EMAIL_BOB).withStudentId(VALID_STUDENTID_BOB).withTags(VALID_MODULE_CS2103,
////                        VALID_MODULE_CS2105).build();
////        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
////
////        assertParseSuccess(parser, userInput, expectedCommand);
////    }
...
////        assertParseSuccess(parser, userInput, expectedCommand);
////    }
////}_AMY + STUDENTID_DESC_AMY + EMAIL_DESC_AMY
//                + MODULE_DESC_CS2105 + PHONE_DESC_AMY + STUDENTID_DESC_AMY + EMAIL_DESC_AMY + MODULE_DESC_CS2105
//                + PHONE_DESC_BOB + STUDENTID_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_TEAM1 + TAG_DESC_TEAM2;
//
//        EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder().withPhone(VALID_PHONE_BOB)
