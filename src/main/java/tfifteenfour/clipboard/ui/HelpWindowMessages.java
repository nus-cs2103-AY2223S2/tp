...
public class HelpWindowMessages {
    ...
    final static String STUDENT_HELP_MESSAGE = "Here is what you can do under the [Student] page.\n" +
            ...
            "3. edit student <INDEX> [n/<NAME>] [p/<PHONE_NUMBER>] [e/<EMAIL>] [sid/<STUDENT_NUMBER>]: edits an existing student with the given field\n" +
    ...
    final static String TASK_HELP_MESSAGE = "Here is what you can do under the [Task] page.\n" +
    ...
    final static String ATTENDANCE_HELP_MESSAGE = "Here is what you can do under the [Attendance] page.\n" +
            "1. mark <INDEX> OR mark <INDEX>, <INDEX>, ...: marks selected students’ attendance as present for current session.\n" +
            "\tTry this: mark 1 OR mark 2,3,4\n" +
            "2. unmark <INDEX> OR unmark <INDEX>, <INDEX>, ...: unmarks selected students’ attendance as absent for current session.\n" +
            "\tTry this: unmark 1 OR unmark 2,3,4\n" +
            "3. attendance: displays the attendance of the current session\n" +
            "\tTry this: attendance";

    final static String GRADES_HELP_MESSAGE = "Here is what you can do under the [Grades] page.\n" +
