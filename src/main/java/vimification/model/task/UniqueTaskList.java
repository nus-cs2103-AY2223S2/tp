 ...
 * A tasks is considered unique by comparing using {@code Task#isSameTask(Task)}. As such, adding and updating of
...
public class UniqueTaskList implements Iterable<Task> {
    ...
    public void mark(Task task) {
        ...
        internalList.get(index).setDone();
    }

    public void unmark(Task task) {
        requireNonNull(task);
        int index = internalList.indexOf(task);
        internalList.get(index).setNotDone();
    }
