 ...
 * 3. An argument may be repeated and all its values will be accumulated e.g. the value of
...
public class ArgumentTokenizer {
     ...
     * from index {@code fromIndex}. An occurrence is valid if there is a whitespace before
     * {@code prefix}. Returns -1 if no such occurrence can be found.
     *
     ...
     * {@code currentPrefixPosition}. The end position of the value is determined by
     * {@code nextPrefixPosition}.
     */
