...
public class Messages {
    ...
    public static final String MESSAGE_BOOK_BORROWED_NOT_FOUND = "The person has borrowed a book but is not found in book list";
    public static final String MESSAGE_BORROWER_NOT_FOUND = "The book is borrowed but the person is not found in person list";
