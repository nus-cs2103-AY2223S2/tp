...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_DELETE_PERSON =
        "Please return all books before deleting the person! \nAlternatively, use 'deletePerson PERSON_INDEX -f'"
        + "to return all books while deleting the person.";
    public static final String MESSAGE_INVALID_DELETE_BOOK =
        "Please return the book before deleting it! \nAlternatively, use 'deleteBook BOOK_INDEX -f'"
        + "to return it while deleting the book.";
