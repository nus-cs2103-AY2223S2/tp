...
import seedu.patientist.storage.PatientistStorage;
import seedu.patientist.storage.Storage;
import seedu.patientist.storage.StorageManager;
import seedu.patientist.storage.UserPrefsStorage;
import seedu.patientist.ui.Ui;
import seedu.patientist.ui.UiManager;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing Patientist ]===========================");
        super.init();
        ...
        PatientistStorage patientistStorage = new JsonPatientistStorage(userPrefs.getPatientistFilePath());
        storage = new StorageManager(patientistStorage, userPrefsStorage);
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s patientist book and {@code userPrefs}. <br>
     * The data from the sample patientist book will be used instead if {@code storage}'s patientist book is not found,
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            initialData = patientistOptional.orElseGet(SampleDataUtil::getSamplePatientist);
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty Patientist");
            initialData = new Patientist();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting Patientist " + MainApp.VERSION);
