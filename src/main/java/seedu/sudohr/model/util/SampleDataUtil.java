    ...
    public static Employee[] getSampleEmployees() {
        return new Employee[] {
            new Employee(new Id("1"), new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                getTagSet("friends")),
            new Employee(new Id("2"), new Id("2"), new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("colleagues", "friends")),
            new Employee(new Id("3"), new Name("Charlotte Oliveiro"), new Phone("93210283"),
                    new Email("charlotte@example.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTagSet("neighbours")),
            new Employee(new Id("4"), new Id("4"), new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getTagSet("family")),
            new Employee(new Id("5"), new Id("5"), new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
