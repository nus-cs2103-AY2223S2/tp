    ...
    public static Person[] getSamplePersons() {
        return new Person[]{
            new Person(new Nric("S1234567A"), new Name("Alex Yeoh"), new Phone("87438807"),
                ...
                new DrugAllergy("NKDA"), new Gender("male"), getTagSet("Diabetic"), getMedicineSet("Lantus")),
            new Person(new Nric("S2345678B"), new Name("Bernice Yu"), new Phone("99272758"),
                new Email("berniceyu@example.com"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                new DrugAllergy("Panadol"), new Gender("female"), getTagSet("Osteoporotic", "Diabetic"),
            ...
            new Person(new Nric("S3456789C"), new Name("Charlotte Oliveiro"), new Phone("93210283"),
                ...
                new DrugAllergy("Penicillin"), new Gender("male"), getTagSet("Asthmatic"), getMedicineSet()),
            new Person(new Nric("S0012345D"), new Name("David Li"), new Phone("91031282"),
                    new Email("lidavid@example.com"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                new DrugAllergy("Aspirin Panadol"), new Gender("male"), getTagSet("Epileptic"), getMedicineSet("DHAP", "DTIC")),
            new Person(new Nric("S1212345E"), new Name("Irfan Ibrahim"), new Phone("92492021"),
                    new Email("irfan@example.com"), new Address("Blk 47 Tampines Street 20, #17-35"),
                new DrugAllergy("NKDA"), new Gender("male"), getTagSet("Arthritic"), getMedicineSet("NTRI")),
            new Person(new Nric("S0001111F"), new Name("Roy Balakrishnan"), new Phone("92624417"),
                    new Email("royb@example.com"), new Address("Blk 45 Aljunied Street 85, #11-31"),
                    new DrugAllergy("NKDA"), new Gender("male"), getTagSet("Diabetic"), getMedicineSet())
