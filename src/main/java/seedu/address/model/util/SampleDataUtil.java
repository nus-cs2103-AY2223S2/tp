...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {new Person(new Name("Alex Yeoh"), new Phone("87438807"),
                ...
                getTagSet("friends")), new Person(new Name("Bernice Yu"), new Phone("99272758"),
                    new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                        new PayRate("123"),
                        new Session("28-02-2022 23:00", "01-03-2022 00:00"),
                        getTagSet("colleagues", "friends")), new Person(new Name("Charlotte Oliveiro"),
                        ...
                        getTagSet("family")), new Person(new Name("Irfan Ibrahim"), new Phone("92492021"),
