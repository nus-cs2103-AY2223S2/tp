...
public class SampleDataUtil {
    ...
    public static ReadOnlyExpenseTracker getSampleAddressBook() {
        ExpenseTracker sampleAb = new ExpenseTracker();
    ...
    public static ReadOnlyExpenseTracker getSampleCategoryData() {
        ExpenseTracker sampleAb = new ExpenseTracker();
