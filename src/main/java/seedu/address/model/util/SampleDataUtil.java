    ...
    public static Role[] getSampleRoles() {
        return new Role[] {
            new Role(new Name("SWE at Google"), new Phone("87438807"), new Email("google@example.com"),
                ...
                getTagSet("Tech"), new Website("www.gohome.com"), new Salary("8000"), new Deadline("2023-06-15"), new Experience("Javascript - 1 Year")),
            new Role(new Name("Data Analyst at Facebook"), new Phone("99272758"), new Email("facebook@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new JobDescription("Open to non-CS majors"),
                getTagSet("Tech"), new Website("www.gohome.com"), new Salary("10000"), new Deadline("2023-05-05"), new Experience("C - 1 Year")),
