...
public class SampleDataUtil {
    public static Fish[] getSampleFishes() {
        ...
        return new Fish[] {
            new Fish(new Name("Fish 1"), new LastFedDateTime("01/11/2023"), new Species("Guppy"),
                new FeedingInterval("1d0h"), tanks[0],
                    getTagSet("tempSpeciesA")),
            new Fish(new Name("Fish 2"), new LastFedDateTime("01/11/2023"), new Species("Tetra"),
                new FeedingInterval("0d5h"), tanks[0],
                    getTagSet("tempSpeciesA", "anotherTag")),
            new Fish(new Name("Fish 3"), new LastFedDateTime("01/11/2023"), new Species("Parrot Fish"),
                new FeedingInterval("1d5h"), tanks[0],
                    getTagSet("tempSpeciesB")),
            new Fish(new Name("Fish 4"), new LastFedDateTime("01/11/2023"), new Species("Arowana"),
                new FeedingInterval("2d0h"), tanks[1],
                    getTagSet("tempSpeciesA")),
            new Fish(new Name("Fish 5"), new LastFedDateTime("01/11/2023"), new Species("Flowerhorn"),
                new FeedingInterval("1d12h"), tanks[1],
                    getTagSet("tempSpeciesB")),
            new Fish(new Name("Fish 6"), new LastFedDateTime("01/11/2023"), new Species("Beta Fish"),
