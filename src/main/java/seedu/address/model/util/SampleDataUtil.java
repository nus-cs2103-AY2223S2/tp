...
public class SampleDataUtil {
    public static Pet[] getSamplePets() {
        return new Pet[] {
            ...
            new Pet(new OwnerName("June Tan"), new Name("Max"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("GoldenRetriever")),
            new Pet(new OwnerName("Ben Leo"), new Name("Charlie"), new Phone("93210283"), new Email("charlotte@example.com"),
            ...
            new Pet(new OwnerName("Alexandra Toh"), new Name("Lola"), new Phone("92624417"), new Email("royb@example.com"),
