    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Nric("S1234567A"), new Name("Alex Yeoh"), new Phone("87438807"),
                    new Email("alexyeoh@example.com"), new Address("Blk 30 Geylang Street 29, #06-40"), new Gender("male"),
                getTagSet("friends")),
            new Person(new Nric("S2345678B"), new Name("Bernice Yu"), new Phone("99272758"),
                new Email("berniceyu@example.com"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new Gender("female"),
                getTagSet("colleagues", "friends")),
            new Person(new Nric("S3456789C"), new Name("Charlotte Oliveiro"), new Phone("93210283"),
                    new Email("charlotte@example.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new Gender("male"),
                getTagSet("neighbours")),
            new Person(new Nric("S0012345D"), new Name("David Li"), new Phone("91031282"),
                    new Email("lidavid@example.com"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new Gender("male"),
                getTagSet("family")),
            new Person(new Nric("S1212345E"), new Name("Irfan Ibrahim"), new Phone("92492021"),
                    new Email("irfan@example.com"), new Address("Blk 47 Tampines Street 20, #17-35"), new Gender("male"),
