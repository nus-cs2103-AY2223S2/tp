    ...
    public static Module[] getSampleModules() {
        return new Module[] {
            new Module(new Name("CS4243"), new Resource("www.google.com"),
                new TimeSlot("Tuesday 2-4 pm"), new Address("LT19"),
