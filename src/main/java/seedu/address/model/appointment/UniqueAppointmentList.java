 ...
 * As such, adding and updating of appointments uses Appointment#isSameAppointment(Appointment) for equality to ensure
 * that the appointment being added or updated is unique in terms of identity in the UniqueAppointmentList. However, the
 * removal of an appointment uses Appointment#equals(Object) to ensure that the appointment with exactly the same
