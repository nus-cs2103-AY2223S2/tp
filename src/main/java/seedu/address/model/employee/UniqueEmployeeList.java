 ...
 * A employee is considered unique by comparing using {@code Person#isSamePerson(Person)}. As such, adding and updating of
 * employees uses Person#isSamePerson(Person) for equality so as to ensure that the employee being added or updated is
