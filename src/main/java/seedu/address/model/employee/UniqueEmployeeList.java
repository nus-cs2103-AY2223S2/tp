 ...
 * An employee is considered unique by comparing using {@code Person#isSamePerson(Person)}. As such, adding and updating
 * of employees uses Person#isSamePerson(Person) for equality so as to ensure that the employee being added or updated
 * is unique in terms of identity in the UniqueEmployeeList. However, the removal of an employee uses
...
public class UniqueEmployeeList implements Iterable<Employee> {
    ...
    /**
     * Replaces the contents of this list with {@code employee's}.
