...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setEduMateFilePath(newUserPrefs.getEduMateFilePath());
    }
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
                && eduMateFilePath.equals(o.eduMateFilePath);
    }

    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, eduMateFilePath);
    }
    ...
    public String toString() {
        ...
        sb.append("\nLocal data file location : " + eduMateFilePath);
        return sb.toString();
    }
