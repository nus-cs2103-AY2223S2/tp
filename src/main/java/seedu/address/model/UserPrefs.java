...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path rerollFilePath = Paths.get("data" , "reroll.json");
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
                && rerollFilePath.equals(o.rerollFilePath);
    }

    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, rerollFilePath);
    }
    ...
    public String toString() {
        ...
        sb.append("\nLocal data file location : " + rerollFilePath);
        return sb.toString();
    }
