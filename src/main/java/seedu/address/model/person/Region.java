 ...
 * 
 * <p> To create a region object, either call the base constructor with a 
...
public class Region {
    ...
    /**
     * Enum that has all the towns in Singapore and their respective regions. <p>
    ...
    /**
     * Constructor for a new Region object. <p>
     ...
     * https://va.ecitizen.gov.sg/CFP/CustomerPages/NEA_google/displayresult.aspx?MesId=1068932&Source=Google&url=va.ecitizen.gov.sg <p>
