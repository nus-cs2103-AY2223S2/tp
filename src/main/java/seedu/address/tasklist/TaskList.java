package seedu.address.tasklist;
...
public class TaskList {
    ...
    private void markUnmark(int taskNumber, boolean toMark) throws Exception {
        ...
        if (isValidTaskNumber) {
            ...
            throw new Exception("Sorry... That is an invalid task number :/");
        }
     ...
     * @throws Exception When the task number given is not valid.
     */
     ...
     * @throws Exception When the task number given is not valid.
     */
    public void unmarkTask(int taskNumber) throws Exception {
