...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String DELETE_COMMAND_MESSAGE = "4) Deletes the patient with the specified NRIC from the address book: \nFormat: delete INDEX\n";
    public static final String FILTER_COMMAND_MESSAGE = "5) Filters patients according to a particular attribute. Eg. Medicine usage or health conditions: \nFormat: filter KEYWORD [MORE_KEYWORDS]";
