...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String COMMAND_SUMMARY =
            "Prefix:\n"
                    ...
                    + "\n" + "edit INDEX [z/FIELD]…"
                    + "                                  "
                    + "Edits the fields for the conatct at index\n"
                    + "edit [z/FIELD]..."
                    + "                                              "
                    ...
                    + "\n" + "find z/[FIELD] [MORE_FIELDS]…"
                    + "                   "
                    + "Accepts only one Prefix, accepts multiple keywords\n"
                    + "\n"
                    + "sort"
                    + "                                                               "
                    ...
                    + "sort z/a"
                    + "                                                         "
                    + "Sorts the contacts by their z attribute in ascending order\n"
                    + "sort z/d"
                    + "                                                         "
                    + "Sorts the contacts by their z attribute in descending order\n"
                    + "sort z/"
                    + "                                                           "
                    + "Sorts the contacts by their z attribute based on the default order\n"
                    + "sort z1/ z2/" + "                                                   "
                    + "Sorts the contacts by their z1 attribute, and breaks ties using their z2 attribute\n"
                    + "sort [z/]…" + "                                                      "
                    ...
                    + "\n" + "meet [INDEX]..."
                    + "                                             "
                    + "Suggests locations to meet with contacts at the indexes\n"
                    + "eat [INDEX]…" + "                                                "
                    + "Suggests locations to eat with contacts at the indexes\n"
                    + "study [INDEX]…" + "                                            "
                    + "Suggests locations to study with contacts at the indexes\n"
                    + "\n"
                    + "Tips:\n"
                    + "Press UP key when textfield is selected"
                    + "         "
                    + "Loads previous command into textfield\n"
                    + "Press DOWN key when textfield is selected"
                    + "  "
