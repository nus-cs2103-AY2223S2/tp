...
import seedu.address.ui.cli_section.CliSection;
import seedu.address.ui.cli_section.CommandBox;
import seedu.address.ui.graphics_section.GraphicsSection;
...
//    }
     ...
     */
    void fillInnerParts() {
        GraphicsSection graphicsSection = new GraphicsSection();
        graphicsSectionPlaceholder.getChildren().add(graphicsSection.getRoot());

        CliSection cliSection = new CliSection();
