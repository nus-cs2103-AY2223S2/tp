...
/**
 * Parses input arguments and creates a new TimeStampCommand object
 */

public class TimeStampCommentCommandParser implements Parser<TimeStampCommentCommand> {
    /**
     * Parses the given {@code String} of arguments in the context of the TimeStampCommentCommand
     * and returns an TimeStampCommentCommand object for execution.
     * @throws ParseException if the user input does not conform the expected format
     */

    public TimeStampCommentCommand parse(String args) throws ParseException {
        ...
        if (presentPrefixes.size() < 4) {
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, TimeStampCommentCommand.MESSAGE_USAGE));
        }
        ...
        return new TimeStampCommentCommand(comments, moduleCode, lectureName, videoName, videoTimestamp);
