 ...
 */
public class AddTechnicianToServiceCommandParser implements Parser<AddTechnicianToServiceCommand> {
    /**
     ...
     */
    public AddTechnicianToServiceCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_TECHNICIAN_ID, PREFIX_SERVICE_ID)
            ...
            throw new ParseException(
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddTechnicianToServiceCommand.COMMAND_USAGE));
        }
        ...
        return new AddTechnicianToServiceCommand(techId, serviceId);
    }
