 ...
 */
public class RemoveTechnicianFromAppointmentCommandParser implements Parser<RemoveTechnicianFromAppointmentCommand> {
    /**
     ...
     */
    public RemoveTechnicianFromAppointmentCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_TECHNICIAN_ID, PREFIX_APPOINTMENT_ID)
            ...
            throw new ParseException(
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, RemoveTechnicianFromAppointmentCommand.COMMAND_USAGE));
        }
