...
public class EditNoteCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = "Edit syntax: edit-note -index INDEX (must be a positive integer) -content updated-note -name name-of-event -type type-of-event";
    public static final String MESSAGE_EXAMPLE = "edit-note -index 1 -content this is my updated notes -name tutorial 1 -type tutorial";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_EDIT_NOTE_SUCCESS), false, false, false, true);
    }
