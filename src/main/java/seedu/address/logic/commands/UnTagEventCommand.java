...
public class UnTagEventCommand extends Command {
    ...
    private static final String MESSAGE_SUCCESS = "%1$s is now untagged from the event indexed as %2$s";
    private static final String MESSAGE_SUCCESS_2 = "%1$s is already untagged from the event indexed as %2$s";
