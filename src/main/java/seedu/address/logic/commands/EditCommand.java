...
public class EditCommand extends Command {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Calorie updatedCalorie = editPersonDescriptor.getCalorie().orElse(personToEdit.getCalorie());
        return new Person(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedCalorie, updatedTags);
    }
