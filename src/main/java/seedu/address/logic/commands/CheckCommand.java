...
public class CheckCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        String nameKeywords = studentToCheck.getName().fullName;

        model.updateFilteredStudentList(person -> person.getName().fullName.equals(nameKeywords));
        return new CommandResult(String.format(MESSAGE_CHECK_PERSON_SUCCESS, studentToCheck));
    }
