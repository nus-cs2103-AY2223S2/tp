...
public class DeleteVehicleCommand extends RedoableCommand {
    ...
    public static final String MESSAGE_DELETE_PERSON_SUCCESS = "Deleted Vehicle: %1$s";
    ...
    public CommandResult executeUndoableCommand(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_DELETE_PERSON_SUCCESS, vehicleToDelete));
    }
