...
public class TagEventCommand extends Command {
    ...
    private static final String MESSAGE_SUCCESS = "%1$s is now tagged to the event indexed %2$s";
    private static final String MESSAGE_SUCCESS_2 = "%1$s is already tagged to the event indexed %2$s";
