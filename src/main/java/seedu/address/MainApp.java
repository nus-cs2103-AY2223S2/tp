...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing NeoBook ]===========================");
        super.init();
        ...
        JsonUserDataStorage userDataStorage = new JsonUserDataStorage(userPrefs.getUserDataFilePath());
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with blank UserData");
            initialUserData = new UserData();
        }
        return new ModelManager(initialAddressBookData, userPrefs, initialUserData);
    }
