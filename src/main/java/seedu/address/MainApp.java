...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing PowerConnect ]===========================");
        super.init();
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Data file not in the correct format. Will be starting with an empty PowerConnect");
            initialClasses = new PcClass();
            initialParents = new Parents();
        } catch (IOException e) {
            logger.warning("Problem while reading from the file. Will be starting with an empty PowerConnect");
            initialClasses = new PcClass();
            initialParents = new Parents();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting PowerConnect " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping PowerConnect ] =============================");
        try {
