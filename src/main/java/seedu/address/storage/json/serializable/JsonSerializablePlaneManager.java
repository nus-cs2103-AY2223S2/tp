...
public class JsonSerializablePlaneManager extends JsonItemManager<Plane, JsonAdaptedPlane> {
    @JsonCreator
     ...
     */
    public static JsonSerializablePlaneManager from(ReadOnlyItemManager<Plane> manager) {
