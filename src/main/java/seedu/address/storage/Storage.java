 ...
 */
public interface Storage extends AddressBookStorage, UserPrefsStorage, DeliveryJobSystemStorage {
    ...
    @Override
    void saveDeliveryJobSystem(ReadOnlyDeliveryJobSystem deliveryJob) throws IOException;
