...
class JsonAdaptedPair {
     ...
     */
    public Pair toModelType(AddressBook addressBook) throws IllegalValueException {
        if (elderlyName == null) {
        ...
        Person elderly = addressBook.getPerson(modelElderlyName);
        ...
        Person volunteer = addressBook.getPerson(modelVolunteerName);
