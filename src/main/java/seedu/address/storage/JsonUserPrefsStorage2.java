...
public class JsonUserPrefsStorage2 implements UserPrefsStorage2 {
    ...
    @Override
    public Optional<UserPrefs2> readUserPrefs() throws DataConversionException {
     ...
     */
    public Optional<UserPrefs2> readUserPrefs(Path prefsFilePath) throws DataConversionException {
