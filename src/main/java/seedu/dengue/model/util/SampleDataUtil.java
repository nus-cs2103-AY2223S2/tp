...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Postal("674388"), new Date("2000-11-11 00:00"),
                new Age("111"),
                getTagSet("friends")),
            new Person(new Name("Bernice Yu"), new Postal("992727"), new Date("2000-11-11 00:00"),
                new Age("11"),
                getTagSet("colleagues", "friends")),
            new Person(new Name("Charlotte Oliveiro"), new Postal("932283"),
                    new Date("2000-11-11 00:00"), new Age("0"),
                getTagSet("neighbours")),
            new Person(new Name("David Li"), new Postal("910312"), new Date("2000-11-11 23:00"),
                new Age("1"),
                getTagSet("family")),
            new Person(new Name("Irfan Ibrahim"), new Postal("924921"), new Date("2000-11-11 00:00"),
                new Age("199"),
                getTagSet("classmates")),
            new Person(new Name("Roy Balakrishnan"), new Postal("926247"), new Date("2000-11-11 00:00"),
                new Age("2"),
