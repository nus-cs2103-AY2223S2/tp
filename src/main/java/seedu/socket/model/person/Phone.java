...
/**
 * Represents a Person's phone number in SOCket.
...
public class Phone {
    ...
    /**
     * Should only contain numbers, and should be at least 3 digits long. May be empty.
     */
    ...
    /**
     * Returns true if phone number is empty.
     *
