    ...
    public static Client[] getSampleClients() {
        return new Client[] {
            ...
            new Client(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), getAppointmentSet("12-12-2019 18:30"),
                new Weight("40"), new Gender("M"), new Calorie("1200"), new Goal("lose weight"),
                    getTagSet("family")),
