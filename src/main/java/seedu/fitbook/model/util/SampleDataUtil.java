    ...
    public static Client[] getSampleClients() {
        return new Client[] {
            new Client(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                new Weight("20.2"), new Gender("M"), new Calorie("1200"), new Goal("lose weight"),
                    getTagSet("friends")),
            new Client(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                new Weight("20.4"), new Gender("M"), new Calorie("1200"), new Goal("lose weight"),
            ...
            new Client(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                ...
                new Weight("30.5"), new Gender("M"), new Calorie("1100"), new Goal("lose weight"),
                    getTagSet("neighbours")),
            new Client(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), getAppointmentSet("12-06-2023 18:30"),
                new Weight("40.5"), new Gender("M"), new Calorie("1200"), new Goal("lose weight"),
                    getTagSet("family")),
            new Client(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                ...
                new Weight("50.0"), new Gender("M"), new Calorie("1202"), new Goal("lose weight"),
            ...
            new Client(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                ...
                new Weight("60.6"), new Gender("M"), new Calorie("2356"), new Goal("lose weight"),
