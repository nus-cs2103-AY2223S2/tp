...
import seedu.techtrack.MainApp;
...
public class UiManager implements Ui {
    ...
    private static final String ICON_APPLICATION = "/images/TechTrack.png";
    ...
    private static void showAlertDialogAndWait(Stage owner, AlertType type, String title, String headerText,
        ...
        alert.getDialogPane().getStylesheets().add("view/TechTrackTheme.css");
