...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PROJECT_LIST = "The project list is currently not being shown! You can switch to the project list with the command 'list-client'";
}
