...
import arb.model.tag.exceptions.DuplicateTagException;
import arb.model.tag.exceptions.TagNotFoundException;
...
public class UniqueTagList implements Iterable<Tag> {
    ...
    /**
     * Returns true if the list contains the tag as the given argument.
     */
    ...
    /**
     * Returns true if {@code tags} contains only unique projects.
     */
