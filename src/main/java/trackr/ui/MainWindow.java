...
public class MainWindow extends UiPart<Stage> {
    ...
    private SupplierListPanel personListPanel;
     ...
     */
    void fillInnerParts() {
        personListPanel = new SupplierListPanel(logic.getFilteredSupplierList());
    ...
    public SupplierListPanel getPersonListPanel() {
