...
public class AddAssignmentCommand extends Command {
    ...
    public static final String MESSAGE_SUCCESS = "Assignment %s with %s mark(s) added.";
    public static final String MESSAGE_USAGE = "Format: add_asgn n/{name} (optional: m/{marks})";
