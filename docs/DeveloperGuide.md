...
|--------------------------------------------------------------|
| _Figure 4.3.x_ Improved *Class Diagram* for Model Components |
...
|----------------------------------------------------|
| _Figure 4.4.1_ *Class Diagram* for Logic Component |
...
|---------------------------------------------------------------------------------------------------------|
| _Figure 4.4.4_ *Sequence Diagram* for a typical `delete` command                                        |
