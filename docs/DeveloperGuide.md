...
| `* * *`     | single administrator of small NPOs                                                         | add a pair of a volunteer to an elderly                                         | make sure every elderly member is taken care of                                 |
| `* *`       | single administrator of small NPOs                                                         | find a pair by keyword                                                          | quickly look up important information when required                             |
| `* * *`     | single administrator of small NPOs                                                         | delete a pairing of a volunteer form an elderly                                 | remove pairs that are no longer used                                            |
| `* *`       | single administrator of small NPOs                                                         | view overlapping pairs between the same volunteers or elderly members           | take note of overlapping work.                                                  |
| `* * *`     | single administrator of small NPOs                                                         | filter pairs by involved elderly members                                        | quickly find involved volunteers when elderly members are in need of attention  |
| `* *`       | single administrator of small NPOs                                                         | filter pairs by tags                                                            | quickly find certain groups of elderly members for events or routine checkups   |
| `* *`       | single administrator of small NPOs                                                         | see summaries of number of elderly members assigned to each volunteer           | evenly distribute workload of volunteers                                        |
| `* *`       | single administrator of small NPOs                                                         | see min, max and average number of elderly buddies per volunteer                | evenly distribute workload of volunteers or to request for more resources       |
| `*`         | single administrator of small NPOs                                                         | view past pairings                                                              | pair up members familiar with each other                                        |
| `*`         | single administrator of small NPOs                                                         | making recurring pairings                                                       | handle recurrent changes in pairs.                                              |
| `*`         | single administrator of small NPOs                                                         | adjust frequency and period limit of pairings                                   | facilitate regular swaps of volunteers and elderly members.                     |
| `*`         | single administrator of small NPOs                                                         | track important dates                                                           | facilitate regular volunteer check ins on elderly members.                      |
| `*`         | single administrator of small NPOs                                                         | set up reminders                                                                | remind volunteers of their commitments                                          |
