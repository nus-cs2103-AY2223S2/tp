...
1. Deleting a person while all persons are being shown
   ...
   2. Test case: `delete 1`<br>
      Expected: An alert window will prompt up and ask user to confirm this deletion. Once confirmed, the first contact is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.
