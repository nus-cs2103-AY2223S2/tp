...
| `* * *`  | user                                       | add a new tutee               |                                                                        |
| `* * *`  | user                                       | delete a tutee                | remove entries that I no longer need                                   |
| `* * *`  | user                                       | find a tutee by name          | locate details of tutees without having to go through the entire list |
| `* *`    | user                                       | hide private contact details   | minimize chance of someone else seeing them by accident                |
| `*`      | user with many tutees in the address book | sort tutees by name           | locate a tutee easily                                                 |
...
2.  AddressBook shows a list of tutees
3.  User requests to delete a specific tutee in the list
4.  AddressBook deletes the tutee
