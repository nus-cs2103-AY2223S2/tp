...
| `* * *`  | user                                       | add a new fish               |                                                                        |
| `* * *`  | user                                       | delete a fish                | remove entries that I no longer need                                   |
| `* * *`  | user                                       | find a fish by name          | locate details of fish without having to go through the entire list |
| `* *`    | user                                       | hide private contact details   | minimize chance of someone else seeing them by accident                |
| `*`      | user with many fish in the address book | sort fish by name           | locate a fish easily                                                 |
...
**Use case: Delete a fish**

**MSS**

1.  User requests to list fish
2.  AddressBook shows a list of fish
3.  User requests to delete a specific fish in the list
4.  AddressBook deletes the fish
...
2.  Should be able to hold up to 1000 fish without a noticeable sluggishness in performance for typical usage.
