...
* stores an `Overview` object that manages the histogram data of the current `UniquePersonList`. It is updated whenever the `Model` is updated with a command execution.
