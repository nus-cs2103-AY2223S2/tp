...
| Test Case                                                                                | Expected Result                                                                                                                                                                    |
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `add Week 7 /mod CS2040S /tags AVLTree, Census`                                          | **Message:**<br/>`New lecture added to module CS2040S: Week 7; Tags: [Census][AVLTree]`<br/>**List updates:** Total number of lectures for the "CS2040S" entry is incremented by 1 |
...
| 1. `nav CS2040S`<br/>2. `add Vid 3 /lec Week 1 /timestamp 01:04:20 /watch /tags Analysis, BigO`           | **Message:**<br/>Same as previous<br/>**List updates:** Total number of videos for the "Week 1" entry is incremented by 1                                                                                                                                                     |
