...
* **New Feature**: Added the ability to add priorities to tasks.
  ...
  * Credits: *nil*
    Fish Ahoy! - is a desktop Fish Manager application used for managing your fish / tanks. The user interacts with it using a CLI, and it has a GUI created with JavaFX. It is written in Java, and has about 10 kLoC.
