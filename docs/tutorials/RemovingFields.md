...
**If you have done the [Add `comment` command tutorial](AddComment.html)  already**, you should know where the code had to be updated to add the field `comment`. From that experience, you can deduce where the code needs to be changed to _remove_ that field too. The removing of the `address` field can be done similarly.
<br>
<br>
