...
import model.mycelium.mycelium.Model;
...
``` java
import static util.commons.mycelium.mycelium.CollectionUtil.requireAllNonNull;
//...
public class RemarkCommand extends Command {
    //...
...
Simply add the following to [`ui.mycelium.mycelium.PersonCard`](https://github.com/se-edu/addressbook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-639834f1e05afe2276a86372adf0fe5f69314642c2d93cfa543d614ce5a76688).
