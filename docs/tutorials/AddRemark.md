...
Create a new `Remark` in `seedu.address.model.person`. Since a `Remark` is a field that is similar to `Station`, we can reuse a significant bit of code.
...
//...
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Person editedPerson = new Person(
                ...
                personToEdit.getStation(), remark, personToEdit.getTags());
