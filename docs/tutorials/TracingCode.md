...
A quick look at the `teambuilder.logic.Logic` (an extract given below) confirms that this indeed might be what we’re looking for.
...
2.  What components will you have to modify to perform the following
    ...
    3.  Save the TeamBuilder in the CSV format instead

    4.  Add a new command

    5.  Add a new field to `Person`

    6.  Add a new entity to the TeamBuilder
