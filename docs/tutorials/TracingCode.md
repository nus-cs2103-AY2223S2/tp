...
Recall from the User Guide that the `edit` command has the format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/STATION] [t/TAG]…​` For this tutorial we will be issuing the command `edit 1 n/Alice Yeoh`.
